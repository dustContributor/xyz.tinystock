...
public class Indexes {
    ...
    private static class Indexes0 extends AbstractKeys {
        public static Index COMPONENT_COMPONENT_UN = createIndex("COMPONENT_UN", Component.COMPONENT, new OrderField[] { Component.COMPONENT.CODE }, true);
        public static Index COMPONENT_PRIMARY = createIndex("PRIMARY", Component.COMPONENT, new OrderField[] { Component.COMPONENT.ID }, true);
        public static Index CUSTOMER_PRIMARY = createIndex("PRIMARY", Customer.CUSTOMER, new OrderField[] { Customer.CUSTOMER.ID }, true);
        public static Index ORDER_ORDER_CUSTOMER_FK = createIndex("ORDER_CUSTOMER_FK", Order.ORDER, new OrderField[] { Order.ORDER.ID_CUSTOMER }, false);
        public static Index ORDER_PRIMARY = createIndex("PRIMARY", Order.ORDER, new OrderField[] { Order.ORDER.ID }, true);
        public static Index ORDER_DETAIL_ORDER_DETAIL_COMPONENT_FK = createIndex("ORDER_DETAIL_COMPONENT_FK", OrderDetail.ORDER_DETAIL, new OrderField[] { OrderDetail.ORDER_DETAIL.ID_COMPONENT }, false);
        public static Index ORDER_DETAIL_ORDER_DETAIL_ORDER_FK = createIndex("ORDER_DETAIL_ORDER_FK", OrderDetail.ORDER_DETAIL, new OrderField[] { OrderDetail.ORDER_DETAIL.ID_ORDER }, false);
        public static Index STOCK_PRIMARY = createIndex("PRIMARY", Stock.STOCK, new OrderField[] { Stock.STOCK.ID_COMPONENT }, true);
        public static Index USER_PRIMARY = createIndex("PRIMARY", User.USER, new OrderField[] { User.USER.ID }, true);
        public static Index USER_USER_UN = createIndex("USER_UN", User.USER, new OrderField[] { User.USER.NAME }, true);
    }
}
