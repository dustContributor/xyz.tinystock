...
public class Keys {
    ...
    private static class Identities0 extends AbstractKeys {
        public static Identity<ComponentRecord, UInteger> IDENTITY_COMPONENT = createIdentity(Component.COMPONENT, Component.COMPONENT.ID);
        public static Identity<CustomerRecord, UInteger> IDENTITY_CUSTOMER = createIdentity(Customer.CUSTOMER, Customer.CUSTOMER.ID);
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<ComponentRecord> KEY_COMPONENT_COMPONENT_UN = createUniqueKey(Component.COMPONENT, "KEY_COMPONENT_COMPONENT_UN", Component.COMPONENT.CODE);
        ...
        public static final UniqueKey<StockRecord> KEY_STOCK_PRIMARY = createUniqueKey(Stock.STOCK, "KEY_STOCK_PRIMARY", Stock.STOCK.ID_COMPONENT);
        public static final UniqueKey<UserRecord> KEY_USER_PRIMARY = createUniqueKey(User.USER, "KEY_USER_PRIMARY", User.USER.ID);
        public static final UniqueKey<UserRecord> KEY_USER_USER_UN = createUniqueKey(User.USER, "KEY_USER_USER_UN", User.USER.NAME);
    }

    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<OrderRecord, CustomerRecord> ORDER_CUSTOMER_FK = createForeignKey(xyz.tinystock.database.Keys.KEY_CUSTOMER_PRIMARY, Order.ORDER, "ORDER_CUSTOMER_FK", Order.ORDER.ID_CUSTOMER);
        public static final ForeignKey<OrderDetailRecord, OrderRecord> ORDER_DETAIL_ORDER_FK = createForeignKey(xyz.tinystock.database.Keys.KEY_ORDER_PRIMARY, OrderDetail.ORDER_DETAIL, "ORDER_DETAIL_ORDER_FK", OrderDetail.ORDER_DETAIL.ID_ORDER);
        public static final ForeignKey<OrderDetailRecord, ComponentRecord> ORDER_DETAIL_COMPONENT_FK = createForeignKey(xyz.tinystock.database.Keys.KEY_COMPONENT_PRIMARY, OrderDetail.ORDER_DETAIL, "ORDER_DETAIL_COMPONENT_FK", OrderDetail.ORDER_DETAIL.ID_COMPONENT);
        public static final ForeignKey<StockRecord, ComponentRecord> STOCK_COMPONENT_FK = createForeignKey(xyz.tinystock.database.Keys.KEY_COMPONENT_PRIMARY, Stock.STOCK, "STOCK_COMPONENT_FK", Stock.STOCK.ID_COMPONENT);
    }
}
